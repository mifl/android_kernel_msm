...
#endif /* CONFIG_F_SKYDISP_FACTORY_SLEEP_ENABLE */
...
#endif /* CONFIG_F_SKYDISP_SHARPNESS_CTRL */
...
#endif /* CONFIG_F_SKYDISP_BACKLIGHT_CMDS_CTL */
...
#if defined(CONFIG_MACH_MSM8974_EF56S) || defined(CONFIG_MACH_MSM8974_EF60S) || \
    defined(CONFIG_MACH_MSM8974_EF65S) || defined(CONFIG_MACH_MSM8974_EF61K) || \
    defined(CONFIG_MACH_MSM8974_EF62L)
	var->height = 122,	/* height of picture in mm */
	var->width = 69,	/* width of picture in mm */
#elif defined(CONFIG_MACH_MSM8974_EF59S) || defined(CONFIG_MACH_MSM8974_EF59K) || \
    defined(CONFIG_MACH_MSM8974_EF59L)
