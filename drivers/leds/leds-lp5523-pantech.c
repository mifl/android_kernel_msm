	...
	if (buf!=NULL) {
		...
		if (strncmp(buf, "upper", 5)==0) {
			...
			for (i=0;i<PAN_NUM_LEDS;i++) {
				if (i==EF59_MENU_KEY || i==EF59_BACK_KEY)
					continue;
...
#elif defined(CONFIG_MACH_MSM8974_EF65S) || defined(CONFIG_MACH_MSM8974_EF60S) || defined(CONFIG_MACH_MSM8974_EF61K) || defined(CONFIG_MACH_MSM8974_EF62L)
		if (i == 4 || i == 5) {
