...
unsigned int skt_charging_mode;
#endif
...
#if defined(CONFIG_MACH_MSM8974_EF65S)
	skt_charging_mode = IS_SYS_SKT_CHARGING_MODE;
#endif
...
#if defined(CONFIG_MACH_MSM8974_EF65S)
unsigned int pantech_sys_rst_is_skt_charging_mode(void)
{
	return skt_charging_mode;
}
#endif